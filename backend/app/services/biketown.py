...
# Baywheels API URL
BAYWHEELS_API_URL = "https://gbfs.lyft.com/gbfs/2.3/pdx"
...
async def get_feed_urls() -> Dict[str, str]:
    """
    Get the URLs for all available Biketown feeds.
    """
...
async def get_stations():
    """
    Get information for all non-virtual Biketown stations with pre-calculated
