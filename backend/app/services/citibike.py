...
# Citibike API URL
CITIBIKE_API_URL = "https://gbfs.citibikenyc.com/gbfs/2.3"

class CitibikeService(BikeShareService):
    """Service for accessing Citibike (NYC) bike sharing data."""
    
    def __init__(self):
        super().__init__(CITIBIKE_API_URL, "citibike")
    
    async def get_stations(self) -> List[StationResponse]:
        """
        Get information for all Citibike stations with pre-calculated
...
router = citibike_service.router