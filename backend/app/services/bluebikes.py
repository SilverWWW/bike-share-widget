...
# Blue Bikes API URL
BLUEBIKES_API_URL = "https://gbfs.bluebikes.com/gbfs"

class BlueBikesService(BikeShareService):
    """Service for accessing Blue Bikes (Boston) bike sharing data."""
    
    def __init__(self):
        super().__init__(BLUEBIKES_API_URL, "bluebikes")
    
    async def get_stations(self) -> List[StationResponse]:
        """
        Get information for all Blue Bikes stations with pre-calculated
...
bluebikes_service = BlueBikesService()
# Export the router for use in the main application
router = bluebikes_service.router